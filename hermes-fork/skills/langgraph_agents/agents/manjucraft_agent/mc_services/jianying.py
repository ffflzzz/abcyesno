    ...
    for i, result in enumerate(shot_results):
        ...
        if result.get("video_path"):
            ...
            draft["materials"]["videos"].append({
                "id": mat_id, "path": f"assets/{video_name}",
                "duration": dur_us, "width": resolution[0], "height": resolution[1],
            })
            video_track["segments"].append({
                ...
                "speed": 1.0,
                "transform": {"scale_x": 1.0, "scale_y": 1.0, "translate_x": 0.0, "translate_y": 0.0, "rotation": 0.0},
            })
        ...
        if result.get("tts_audio_path"):
            ...
            draft["materials"]["audios"].append({"id": mat_id, "path": f"assets/{audio_name}", "duration": dur_us})
        ...
        if subtitle:
            ...
            draft["materials"]["texts"].append({
                "id": mat_id, "content": subtitle,
                "font_family": "Microsoft YaHei", "font_size": 48,
                "text_color": "#FFFFFF", "position": {"x": 0.5, "y": 0.85},
            })
