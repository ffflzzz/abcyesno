...
# Cron jobs were stripped from the portable build.
def get_job(*args, **kwargs):
    raise RuntimeError("Cron jobs are not available in Abcyesno.")
...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin):
    ...
    def process_command(self, command: str) -> bool:
        ...
        if canonical in {"quit", "exit"}:
            ...
            print("  ⚠ In-place updates are not available in Abcyesno.")
            return False
